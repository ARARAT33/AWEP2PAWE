(()=>{'use strict';
const start=()=>{if(window.__aweRuntimeStarted)return;window.__aweRuntimeStarted=true;const s=document.createElement('script');s.src='./runtime.js';s.onload=()=>{const m=document.createElement('script');m.src='./multi-peer.js';m.defer=true;document.body.appendChild(m)};document.body.appendChild(s)};
