(()=>{'use strict';
const start=()=>{if(window.__aweRuntimeStarted)return;window.__aweRuntimeStarted=true;const s=document.createElement('script');s.src='./runtime.js';document.body.appendChild(s)};
